...
public class User {
	...
	/** Retorna el username en funció de si l'usuari el vol mostrar o no */
	public String getUsername() {
		return hideUsername ? "Anònim" : username;
	}
	...
	public String toString() {
		return "User [id=" + id + ", token=" + token + ", username=" + username + ", password=" + password
				+ ", hideUsername=" + hideUsername + ", anonymous=" + anonymous + ", createdAt=" + createdAt
				+ ", rankings=" + rankings + ", roles=" + roles + "]";
	}
