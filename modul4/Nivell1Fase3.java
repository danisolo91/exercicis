...
public class Nivell1Fase3 {
	...
	public static void main(String[] args) {
		...
		if(b500 >= 1) System.out.println(b500 + " billets de 500.");
		importTotal = importTotal % 500;
		b200 = importTotal / 200;
		if(b200 >= 1) System.out.println(b200 + " billets de 200.");
		importTotal = importTotal % 200;
		b100 = importTotal / 100;
		if(b100 >= 1) System.out.println(b100 + " billets de 100.");
		importTotal = importTotal % 100;
		b50 = importTotal / 50;
		if(b50 >= 1) System.out.println(b50 + " billets de 50.");
		importTotal = importTotal % 50;
		b20 = importTotal / 20;
		if(b20 >= 1) System.out.println(b20 + " billets de 20.");
		importTotal = importTotal % 20;
		b10 = importTotal / 10;
		if(b10 >= 1) System.out.println(b10 + " billets de 10.");
		importTotal = importTotal % 10;
		b5 = importTotal / 5;
		if(b5 >= 1) System.out.println(b5 + " billets de 5.");
		importTotal = importTotal % 5;
		m2 = importTotal / 2;
		if(m2 >= 1) System.out.println(m2 + " monedes de 2.");
		importTotal = importTotal % 2;
		m1 = importTotal / 1;
		if(m1 >= 1) System.out.println(m1 + " monedes de 1.");
